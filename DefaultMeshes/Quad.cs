...
namespace GameEngine.DefaultMeshes
{
    public static class Quad
    {
        ...
        private static Mesh _quad = new Mesh(_quadVertices, _quadIndices);
        public static Mesh GetQuad() => new Mesh(_quad.Vertices, _quad.Indices, vao: _quad.ObjectSetupper.VAO);
